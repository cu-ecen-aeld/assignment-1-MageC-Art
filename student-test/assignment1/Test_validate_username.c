...
void test_validate_my_username()
{
    ...
    //TEST_ASSERT_EQUAL_STRING_MESSAGE(my_username(), "MageC-Art",malloc_username_from_conf_file());
    TEST_ASSERT_EQUAL_STRING_MESSAGE(malloc_username_from_conf_file(),"MageC-Art",my_username());
}
